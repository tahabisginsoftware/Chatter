...
function SignIn() {
  ...
  return (
    <>
      <h1 className='welcomeText'>Welcome to Chatter!</h1>
      <h3>Sign in to start Chatting with the community!</h3>
...
function ChatRoom() {
  ...
  return (<>
    ...
    <form onSubmit={sendMessage}>
      ...
      <input value={formValue} onChange={(e) => setFormValue(e.target.value)} placeholder="type in something!" />
